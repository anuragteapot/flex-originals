<template>
  <button class="fo-button">
    ...
    >
      ...
      <path
        style="fill:#263238;"
        d="M206.176,202.688L206.176,202.688l-68.128-55.136c-6.848-5.536-16.96-4.448-22.496,2.4
	...
	C224,225.44,217.504,211.84,206.176,202.688L206.176,202.688z"
      ...
      <path
        style="fill:#FAFAFA;"
        d="M176,256c-8.832,0-16-7.168-16-16s7.168-16,16-16c4.672,0,8.032,1.92,10.016,3.52l0.032,0.032
	C189.824,230.624,192,235.136,192,240C192,248.832,184.832,256,176,256z"
      />
      <path
        style="fill:#263238;"
        d="M396.448,149.952c-5.536-6.88-15.616-7.936-22.496-2.368l-68.128,55.072
	...
	C400.928,166.88,401.984,156.8,396.448,149.952z"
      ...
      <path
        style="fill:#FAFAFA;"
        d="M336,224c8.8,0,16,7.168,16,16s-7.2,16-16,16s-16-7.168-16-16c0-4.864,2.144-9.408,5.952-12.448
	C327.936,225.92,331.328,224,336,224z"
      />
      <path
        style="fill:#263238;"
        d="M336,416c-3.968,0-7.936-1.472-11.04-4.416c-38.656-36.8-99.264-36.768-137.952,0
