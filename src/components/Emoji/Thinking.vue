<template>
  <button class="fo-button" :style="`cursor:${cursor}`">
    <svg
      ...
      :width="width"
      :height="height"
      viewBox="0 0 511.757 511.757"
      style="enable-background:new 0 0 511.757 511.757;"
      xml:space="preserve"
    >
      <g transform="matrix(1.25 0 0 -1.25 0 45)">
        <g>
          <g>
            <path
              style="fill:#FFCC4D;"
              d="M22.658-146.044c0-100.545,81.51-182.044,182.044-182.044
				c100.545,0,182.044,81.499,182.044,182.044C386.747-45.51,305.248,36,204.703,36C104.169,36,22.658-45.51,22.658-146.044"
            />
            <g>
              <path
                style="fill:#664500;"
                d="M175.189-83.467c0-15.713-10.194-28.444-22.756-28.444s-22.756,12.732-22.756,28.444
					c0,15.701,10.194,28.444,22.756,28.444S175.189-67.765,175.189-83.467"
              />
              <path
                style="fill:#664500;"
                d="M295.725-94.844c0-15.713-10.183-28.444-22.756-28.444c-12.561,0-22.756,12.732-22.756,28.444
					c0,15.701,10.194,28.444,22.756,28.444C285.542-66.4,295.725-79.143,295.725-94.844"
              />
              <path
                style="fill:#664500;"
                d="M109.937-36.055c-1.866,0.99-3.447,2.537-4.449,4.528c-2.458,4.881-0.455,10.547,4.471,12.663
              ...
              <path
                style="fill:#664500;"
                d="M167.645-186.686c-1.547,1.445-2.685,3.334-3.14,5.53c-1.126,5.336,2.253,10.308,7.566,11.082
              ...
              <path
                style="fill:#664500;"
                d="M232.362-78.722c-1.775,1.115-3.254,2.765-4.119,4.824c-2.128,5.029,0.262,10.559,5.313,12.334
            ...
            <path
              style="fill:#F4900C;"
              d="M196.465-363.724c0,0,14.393,4.676,16.259,15.383c1.968,11.048-7.1,13.278-7.1,13.278
